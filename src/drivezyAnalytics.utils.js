        ...
        if(isApp){
            ...
            if(isSegement.enable){
                if(!isSegement.key){
                    ...
                    !function () {
                        webAnalytics = window.analytics = window.analytics || [];
                        if (!webAnalytics.initialize) if (webAnalytics.invoked) window.console && console.error && console.error("Segment snippet included twice."); else {
                            webAnalytics.invoked = !0; webAnalytics.methods = ["trackSubmit", "trackClick", "trackLink", "trackForm", "pageview", "identify", "reset", "group", "track", "ready", "alias", "debug", "page", "once", "off", "on"]; webAnalytics.factory = function (t) { return function () { var e = Array.prototype.slice.call(arguments); e.unshift(t); webAnalytics.push(e); return webAnalytics } }; for (var t = 0; t < webAnalytics.methods.length; t++) { var e = webAnalytics.methods[t]; webAnalytics[e] = webAnalytics.factory(e) } webAnalytics.load = function (t) { var e = document.createElement("script"); e.type = "text/javascript"; e.async = !0; e.src = ("https:" === document.location.protocol ? "https://" : "http://") + "cdn.segment.com/webAnalytics.js/v1/" + t + "/webAnalytics.min.js"; var n = document.getElementsByTagName("script")[0]; n.parentNode.insertBefore(e, n) }; webAnalytics.SNIPPET_VERSION = "4.0.0";
                            webAnalytics.load(ENV.SEGMENT_KEYS.WEB);
                            webAnalytics.page();
                        }
                    }();
                }
